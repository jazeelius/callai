...
def get_recent_messages():
  ...
  learn_instruction = {"role": "system", 
                       "content": "You are interviewing the user for a job as a retail assistant. Ask short questionsthat are relevant to the junior position. Keep your answers to under 30 words"}
